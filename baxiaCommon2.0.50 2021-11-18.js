      ...
      , validate = function(e) { // ??????
        ...
        if ("string" == typeof e) {
            if (e.length > 5e4)
                return t.valid = !0,
                t;
            if (!includes(e, "rgv587_flag") && !includes(e, "RGV587_ERROR::SM"))
                return t.valid = !0,
                t;
            try {
                n = JSON.parse(e)
    ...
    var getUA$1 = function(e) {
      ...
      , addNCParamToRequest = function(e) {
        try {
            ...
            o.needUmidToken && c.push({
                key: NC_PARAM_UMIDTOKEN,
                value: r
            });
            var d = getStore("ncData");
            d && d.length > 0 && (c = c.concat(d));
            try {
                SEA_DOMAIN.test(location.host) && (i.location || u.location || console && console.log("umOptions.location not set"),
                c = c.concat([{
                    key: "bx-sys",
                    value: "ua-l:" + (i.location || "no") + "__um-l:" + (u.serviceLocation || "no") + "__js:" + getCurrentJSDomain()
                }]))
            } catch (p) {}
            e = addParamToRequest(t, e, c)
        } catch (p) {
            log("addParamToRequest:" + p.message)
        }
        return e
    }
