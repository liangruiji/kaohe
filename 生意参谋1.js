/*
 * @Author: your name
 * @Date: 2021-09-24 11:58:56
 * @LastEditTime: 2021-09-25 12:22:30
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /kaohe/生意参谋1.js
 */
var baxiaCommon = function() {
    ...
    // getStore =>  window.__baxia__.options || {} || window.__baxia__
                ...
                n.apply(window, e).then(function(n) {
                    try {
                      ...
                      n.clone().text().then(function (i) {
                          // TODO 1
                            return t ? t({
                                parentConfig: a,// fetch的第二个参数
                                parentArguments: e, // fetch全部参数
                                response: n, // fetch返回的
                                data: i, // response转为文本后的
                                resolve: r, // resolve函数
                                reject: o // reject函数
                            }) : (r(n),
                            i)
        ...
        try {
            HookBX$1({
                    ...
                    o) : (s.baxiaData = {
                        ...
                        // TODO 2
                    handler("Fetch", {
                        result: o, // response转为文本后的
                        config: s //  response.config
                    }),
                    t.promise)
                }
            })
