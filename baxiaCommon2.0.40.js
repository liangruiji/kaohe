var baxiaCommon = function () {
  ...
  var win = window,
    ...
    includes = function (e, t) { // 字符串e是否有t
      return !!e && e.indexOf(t) > -1
    },
    isObjectString = function (e) { // e 是否是 JSON
      var t = !0;
      try {
        JSON.parse(e)
      } catch (n) {
    ...
    isEmptyObject = function (e) { // e 是否是空对象
      if (!e) return !0;
    ...
    addQueryString = function (e, t, n) { // url  e 增加 &t=n 
      return includes(e, t) ? e : e.indexOf("?") > -1 ? e + "&" + t + "=" + n : e + "?" + t + "=" + n
    },
    addFormUrlEncoded = function (e, t, n) { // url  e 增加 &t=n 
  ...
  var formatInjectOptions = function (options) {
    ...
    isGray = function () { // 返回 true
      var e = document.currentScript && document.currentScript.src; // 当前js所在的标签
  ...
  var hookRewriteArgumentsAndApply = function (e, t, n) {
    ...
    getPostUA = function () { // 运行 window.__baxia__.postFYModule.getFYToken() ，返回 ua
    ...
    getUmidToken = function () { // window.__baxia__.umidToken
    ...
    _emit = {
      on: function (e, t) { // window.__baxia__.events[e] = t
        return (events[e] || (events[e] = [])).push(t), setStore("events", events), emit
      },
      once: function (e, t) {
        var n = this,
          r = function () { // 装到  window.__baxia__.events 中的函数
      ...
      fire: function (e, t) { // e: events的名字 t: preRequest的参数 // 运行window.__baxia__.events[e]中的函数 
  ...
  var getUA$1 = function (e) { // SubmitType.FetchHeader = 7
    ...
    addNCParamToRequest = function (e) {
      try {
        var t = getNCSubmitType(e), // SubmitType.FetchHeader = 7
          n = getUA$1(t), // ua 值
          r = getUmidToken(), // window.__baxia__.umidToken
          o = getStore("options", {}).needUmidToken, // window.__baxia__.options.needUmidToken
          a = [{
            key: NC_PARAM_UA, // bx-ua
            value: n
          }];
        o && a.push({
          key: NC_PARAM_UMIDTOKEN, // bx-umidtoken
          value: r
        });
        var i = getStore("ncData"); // window.__baxia__.ncData
        i && i.length > 0 && (a = a.concat(i)),
          e = addParamToRequest(t, e, a) // 7 , e , a:[] 装bx-ua的数组  // 增加 ua 到  e.headers中
      } catch (s) {
    ...
    getNCSubmitType = function (e) {
      var t = getCustomSubmitType(e); // SubmitType.FetchHeader = 7
      if (t) return t;
      var n = e.params;
    ...
    getCustomSubmitType = function (e) { // 返回 n: 7
      var t = getStore("options", {}).appendTo, // window.__baxia__.options.appendTo =  header
        n = null;
  ...
  function preRequest(e) { // 把请求函数储存到 window.__baxia__.events 中，如果getFYModule、postFYModule都存在，运行储存到 window.__baxia__.events中的函数
    var t = getStore("options", {}),
      n = t.asac,
      r = t.awscTimeout, // 3000 
    ...
    if (_emit.once(a, function (e) {
        ...
        //   headers: s,
        //   request: {},
        //   isAppend: function () { // 判断请求头是否有bx-ua
      ...
      e.isAppend() || (n && (e = addASACParamToRequest(e)),
        e = addNCParamToRequest(e)), // // 增加 ua 到  e.headers中
        canSubmit() ? e.process(e) : e.canNotSubmit && e.canNotSubmit() // 运行 e.process
      }), !isAwscReady()) {
  ...
  function addParamToRequest(e, t, n) {
    switch (e) {
      ...
      case SubmitType.FetchHeader:
        var r = t.headers || {};
        addParam(t.params, n, function (e) {  // 增加 ua 到  t.headers中
          r[e.key] = e.value
        }), t.headers = r;
        break;
  ...
  function addParam(e, t, n) { // 运行 t.length 次  n函数
  ...
  var initFetch = function () {
    ...
    init$4 = function () {
      var e = getStore('options', {}); // window.__baxia__.options
  ...
  function initGetAWSC(e) {
    ...
    n.MaxMTLog = n.MaxMTLog || 20,
      ...
      t.configFYEx(function (e) {
        setStore("getFYModule", e) // 设置window.__baxia__.getFYModule
      }, n || {}, e.awscTimeout)
  ...
  var init$5 = function (e) {
      void 0 === e && (e = {}),
        ...
        ((e = formatInjectOptions(e)).awscTimeout = e.awscTimeout || 3000,
          setStore("options", e),
          renderNC(e), // 设置window.__baxia__.options.renderNC为 false
          getStore('baxiaInit') || (setStore('baxiaInit', !0), // 设置 window.__baxia__.baxiaInit
