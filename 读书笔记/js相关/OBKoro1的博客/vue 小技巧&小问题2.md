...
# [#](http://obkoro1.com/web_accumulate/codeBlack/你或许不知道Vue的这些小技巧.html#vue-小技巧-小问题2)vue 小技巧&小问题2
...
```js
   ...
   // 数据更新 数组视图不更新
   // 1.数组数据变动：我们使用某些方法操作数组，变动数据时，有些方法无法被vue监测，有些可以
   // 1.1.Vue 不能检测以下变动的数组：
...
推荐使用`splice`方法会比较好自定义,因为slice可以在数组的任何位置进行删除/添加操作，这部分可以看看我前几天写的一篇文章:[【干货】js 数组详细操作方法及解析合集](https://juejin.im/post/6844903614918459406?utm_source=gold_browser_extension#heading-7)
...
如果你还是很困惑，可以看看[Vue文档](https://cn.vuejs.org/v2/guide/list.html#数组更新检测)中关于这部分的解释。

4. **异步更新队列。在最新的项目中遇到了这种情况，数据第一次获取到了，也渲染了，但是第二次之后数据只有在再一次渲染页面的时候更新，并不能实时更新。**
...
![img](https://user-gold-cdn.xitu.io/2018/6/3/163c50e5198f6b8c?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
[Vue 实践过程中的几个问题](https://juejin.im/post/6844903555602612231)
...
作者：OBKoro1
链接：https://juejin.cn/post/6844903616101220365
来源：掘金
