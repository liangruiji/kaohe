...
[JS基础-函数、对象和原型、原型链的关系](https://juejin.im/post/6844903924307230727)

[js基础-面试官想知道你有多理解call,apply,bind？](https://juejin.im/post/6844903906279964686)

### 何为继承？

> [维基百科](https://zh.wikipedia.org/wiki/继承_(计算机科学))：继承可以使得子类具有父类别的各种属性和方法，而不需要再次编写相同的代码。
...
![原型链子类实例](https://user-gold-cdn.xitu.io/2019/9/21/16d539baae94a4e7?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![原型链继承返回其他对象,将导致原型链继承失败](https://user-gold-cdn.xitu.io/2019/9/21/16d539baaec18513?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
> 值得一提的是：很多博客中说，引用类型的属性被所有实例共享，通常会用数组来举例，实际上数组以及其他父类通过`this`声明的属性也只是通过[原型链查找](https://juejin.im/post/6844903924307230727#heading-11)去获取子类实例的原型(`sonFn.prototype`)上的值。
...
![借用构造函数继承的子类实例](https://user-gold-cdn.xitu.io/2019/9/21/16d539baaedb2a77?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
PS: 关于call/apply/bind的更多细节，推荐查看我的博客：[js基础-面试官想知道你有多理解call,apply,bind？[不看后悔系列\]](https://juejin.im/post/6844903906279964686)
...
![组合继承的子类实例](https://user-gold-cdn.xitu.io/2019/9/21/16d539baaeb8f9b4?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![原型式继承](https://user-gold-cdn.xitu.io/2019/9/21/16d539c6be86b1cd?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![寄生组合式继承子类实例](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="778" height="186"></svg>)
...
这段代码是通过[babel在线编译](https://www.babeljs.cn/repl)成es5, 用于子类prototype原型式继承父类`prototype`的属性/方法。
...
对prototype还不是很理解的同学，可以再看看：[JS基础-函数、对象和原型、原型链的关系](https://juejin.im/post/6844903924307230727)
...
作者：OBKoro1
链接：https://juejin.cn/post/6844903950538260494
来源：掘金
