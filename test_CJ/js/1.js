 ...
 * @LastEditTime: 2021-04-28 15:06:45
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /kaohe/test_CJ/js/1.js
 */
...
var baxiaCommon = function() {
    ...
    function isBaxiaBlockByCookie() {
        var e = document.cookie.match(/x5secdata=([^;]+)/)
          , t = e && e[1];
        return !(!e || document.hidden) && (-1 >= handlerSecdata.indexOf(t) && ("__bx__" !== t && ((!window._config_ || !window._config_.action) && (handlerSecdata.push(t),
        clearX5SecData(),
        t))))
    }
    ...
    var doc$1 = document, loadJS = function(e, t, n) {
        ...
        try {
            ...
            var n = _handlerQueue[0]
              , r = "baxia" + n.pluginName + "Handler"
              , o = getHandlerPath(r, n.props);
            loadJS(o, function() {
                if (!pluginInstance) {
                    pluginInstance = new window[r];
            ...
            pluginInstance = null,
            log("handler err，param:" + e + JSON.stringify(t) + "," + a.message + a.stack)
        }
    };
    function init() {
        try {
    ...
    function handler$1(e) {
        setTimeout(function() {
            ...
            t && loadJS(getPunishUrlBySecData(t, e), null)
        }, 500)
    }
    function getPunishUrlBySecData(e, t) {
        return "https://" + decodeURIComponent(e).split("__bx__")[1] + "/_____tmd_____/punish?source=" + t + "&x5step=1&x5secdata=" + e
    }
    function init$1() {
        try {
            handler$1("cookie"),
    ...
    var fetchPrompt = {
      ...
      , init$3 = function() {
        xhrPrompt.init(),
        document.cookie.indexOf("loadbaxiajs") > -1 && cookiePrompt.init(),
        fetchPrompt.init()
    }
    ...
    var hookRewriteArgumentsAndApply = function(e, t, n) {
        ...
        return e && e.getFYToken && e.getFYToken()
    }, getUA = function() {
        return getPostUA()
    }, getGetUA = function() {
    ...
    function preRequest(e) {
        var t = getStore("options", {})
          ...
          , r = t.awscTimeout
          , o = t.needUmidToken;
        _emit.once(EVENT_AWSC_READY, function(e) {
            e.isAppend() || (n && (e = addASACParamToRequest(e)),
            e = addNCParamToRequest(e)),
            canSubmit() ? e.process(e) : e.canNotSubmit && e.canNotSubmit()
        });
        var a = getUmidToken();
        if (o && (-1 !== a.indexOf("defaultToken1") || -1 !== a.indexOf("defaultToken3")))
            return setTimeout(function() {
                _emit.fire(EVENT_AWSC_READY, e)
            }, r + 200),
            e;
        _emit.fire(EVENT_AWSC_READY, e)
    }
    function addParamToRequest(e, t, n) {
        ...
        case SubmitType.XHRHeader:
            addParam(t.params, n, function(e) {
                var n = e.key
                  , r = e.value;
                t.request.setRequestHeader(n, r)
            });
            break;
