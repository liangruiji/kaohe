/*
 * @Author: your name
 * @Date: 2021-04-28 15:07:36
 * @LastEditTime: 2021-04-29 10:34:53
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /kaohe/test_CJ/js/3.js
 */
...
var baxiaCommon = function() {
    ...
    var win = window
      , BAXIA_KEY = "__baxia__"
      , getStore = function(e, t) { // 获得__baxia__里的属性
        var n = win[BAXIA_KEY] || {};
        return e ? n[e] || t : n
    }
      , setStore = function(e, t) { // 设置__baxia__里的属性
        win[BAXIA_KEY] = win[BAXIA_KEY] || {},
        win[BAXIA_KEY][e] = t
    }
      , includes = function(e, t) {  // 字符串e中是否有t
        return !!e && e.indexOf(t) > -1
    }
      , isObjectString = function(e) { // 判断e是否能序列化，返回布尔
        var t = !0;
        try {
            JSON.parse(e)
        } catch (n) {
      ...
      , isEmptyObject = function(e) { // 判断是否是空的Obj
        if (!e)
            return !0;
        for (var t in e)
            return !1;
    ...
    function addVersionToUrl(e) { // 判断__baxia__里options配置项是否addVersionToUrl方法，
    ...
    function endsWith(e, t) { // 判断e字符串中是否已以t结尾，用于判断js、css文件
        return !!e && e.substring(e.length - t.length) === t
    }
    function formatJsonp(e) { // 返回e
        if ("string" != typeof e)
            return e;
        var t = e.match(/^\w+\(({[^()]+})\)$/);
        return t && (e = t[1]),
    ...
    var formatInjectOptions = function(options) {  // 格式化下options，然后返回
      ...
      , isGray = function() {  // 返回 document.currentScript.src中的ratio是否大于随机数
      ...
      , log = function(e, t, n) {
        ...
        0 >= n || Math.random() < n) && _send({
            ...
            pid: "baxia",
            page: loc.href.split(/[#?]/)[0], //  url 地址 ？前面的数据
            query: loc.search.substr(1), // url 地址 ？后面的数据
            hash: loc.hash,
            referrer: doc.referrer, // html的渲染的地址 
            title: doc.title, // 标题
            ua: navigator.userAgent // 用户信息
        }, "//gm.mmstat.com/fsp.1.1?")
    };
    function importantLog(e) { // 调用log
        log(e, 13, .1)
    }
    function _send(e, t) { // 把e中的信息拼接到img标签的src中
        var n = [];
        for (var r in e)
            n.push(r + "=" + encodeURIComponent(e[r]));
        (new Image).src = t + n.join("&")
    }
    var addEvent = function(e, t, n, r) { // t监听事件，e,n,r作为参数
        if (void 0 === r && (r = !1),
        t.addEventListener)
      ...
      , isSupportedHookProperty = function() {  // 判断是否可以使用Object.defineProperty,返回的是XMLHttpRequest.prototype.readyState
        var e = {
            test: "true"
        };
        try {
      ...
      , hookProperty = function(e, t, n, r) { // 为e.t添加 get、set属性
      ...
      , resetReadonlyProperty = function(e, t, n) { // 把e对象的t属性改为可写入，n赋值给e.t
        Object.defineProperty(e, t, {
            writable: !0
        }),
        e[t] = n
    }
      , validate = function(e) {  // e中有rgv587_或assist_flag或url时，返回{valid:false} ,否则返回{valid: true}
        void 0 === e && (e = "");
        var t = {
            valid: !1,
            type: ""
        ...
        return n || r ? t : (t.valid = !0,
        t)
    };
    function handleAutoResponse(e) { // 把e中的window._config_赋值给t，e赋值给t.data,返回t
        var t = e;
        try {
    ...
    var handlerSecdata = []; // cookie中的x5secdata数据
    function isBaxiaBlockByCookie() { // 取cookie中的x5secdata ，并返回
    ...
    function clearCookie(e) { // 设置document.cookie
        var t = new Date;
    ...
    function clearX5SecData() { //清除document.cookie中的x5secdata数据
        try {
    ...
    var XHRPrototype = XMLHttpRequest.prototype
      , _event = null
      , HookBX = function(e) { // 为XMLHttpRequest.prototype设置readyState属性,
        var t = e.done;
        try {
        ...
        XHRPrototype.addEventListener && hookRewriteArguments(XHRPrototype, "addEventListener", function() {
            var e = toArray(arguments)
              , n = e[1];
    ...
    function getResponse(e, t) {  //读取e.response.window._config,读取Blob文件数据，并返回
        var n = "";
        try {
            if ((n = handleAutoResponse(n = e.response || e.responseText))instanceof Blob && t) {
                ...
                r.onload = function() {
                    try {
                        var e = JSON.parse(this.result); // #TODO this.result是啥
                        t(e)
                    } catch (n) {
                        t("")
                    }
    ...
    var doc$1 = document, loadJS = function(e, t, n) {  // 插入src为e的script标签，并添加加载后监听事件函数t
        if (!e)
            return t();
    ...
    }, loadCSS = function(e) { // 插入href为e的link标签,css文件，
        ...
        n.href = e,
        t.appendChild(n)
    }, getHandlerPath = function(e, t) { // 获得处理程序地址，t.result.jsPath 或从window.__baxia__属性中获得cdnPath 都没取 https://g.alicdn.com/sd/baxia/" + version + "/") + e + ".js
        ...
        try {
            ...
            var r = _handlerQueue[0]
              ...
              , a = getHandlerPath(o, r.props); // 处理程序地址
            loadJS(a, function() {  // 插入js
                if (!pluginInstance) {
            ...
            pluginInstance = null,
            log("handler err，param:" + e + JSON.stringify(t) + "," + i.message + i.stack)
        }
    };
    function init() { 
        try { #TODO 这里
            HookBX({ // 
                done: function(e, t) {  // 在296行调用了
                    var n = e.response
                      , r = e.readyState
                      , o = e.xhr
                      , a = e.eventKey;
                    n || (n = getResponse$1(o)),
                    o._processing || (o._processing || 3 > r || validate(n).valid ? t && t() : (o._processing = !0,
    ...
    var xhrPrompt = { // 版本号和 init函数
        version: version,
        init: init
    };
    function getResponse$1(e) { // 获得 e.response 或  e.responseText 或 “”
        var t = "";
        try {
    ...
    function initXHR() { // 为XMLHttpRequest.prototype.open运行前添加readystatechange事件监听函数
    ...
    function getPunishUrlBySecData(e, t) {  // e 是 cookie中的x5secdata  t 是 'xhr' 字符串
      ...
      , HookBX$1 = function(e) {
        ...
        n && (window.fetch = function() {
            ...
            return new window.Promise(function(r, o) {
                var a = e[1] || {};
                a.credentials && "omit" !== a.credentials || (a.credentials = "same-origin"),
    ...
    function init$2() {
        try {
            HookBX$1({
                    ...
                    var t, n = e.parentArguments, r = e.response, o = e.data, a = e.resolve, i = e.reject, s = o.config || {};
                    return s && ((s = e.parentConfig).url = n[0].url || n[0]),
                    o = handleAutoResponse(o),
                    validate(o).valid ? ((t = s.baxiaData && s.baxiaData.defer) ? t.resolve(r) : a(r),
                    o) : (s.baxiaData = {
                        defer: t = {
                            resolve: a,
                            reject: i
    ...
    var getUA$1 = function(e) {
      ...
      , addNCParamToRequest = function(e) {
        try {
            ...
            i && i.length > 0 && (a = a.concat(i)),
            e = addParamToRequest(t, e, a)
        } catch (s) {
    ...
    function initUmidToken(e) {
        ...
        window.AWSC.use("um", function(n, r) {
            ...
            e.umOptions.serviceLocation = e.umOptions.serviceLocation || getDefaultLocation(),
            e.umOptions.timeout = e.awscTimeout,
            "loaded" === n ? (t = "defaultToken3_init_callback_not_called@@" + location.href + "@@" + (new Date).getTime(),
            r.init(e.umOptions, function(e, n) {
                t = "success" === e ? n.tn : "defaultToken4_init_failed with " + e + "@@" + location.href + "@@" + (new Date).getTime(),
                setStore("umidToken", t)
            })) : t = "defaultToken2_load_failed with " + n + "@@" + location.href + "@@" + (new Date).getTime(),
            setStore("umidToken", t)
        }),
        setStore("umidToken", t)
    }
