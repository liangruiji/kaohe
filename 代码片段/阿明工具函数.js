class F {
    ...
    getRivalShops() {
        var G = this['getInstanceProps']()
          , H = [];
        return G['hasOwnProperty']('selfShopInfo') && G['selfShopInfo']instanceof Object && 0x0 < x()(G['selfShopInfo'])['length'] && H['push']({
        ...
        G['hasOwnProperty']('rivalShop1') && G['rivalShop1']instanceof Object && 0x0 < x()(G['rivalShop1'])['length'] && H['push']({
        ...
        G['hasOwnProperty']('rivalShop2') && G['rivalShop2']instanceof Object && 0x0 < x()(G['rivalShop2'])['length'] && H['push']({
    ...
    getRivalItems() {
        var G = this['getInstanceProps']()
          , H = [];
        return G['hasOwnProperty']('selfItem') && G['selfItem']instanceof Object && 0x0 < x()(G['selfItem'])['length'] && H['push']({
        ...
        G['hasOwnProperty']('rivalItem1') && G['rivalItem1']instanceof Object && 0x0 < x()(G['rivalItem1'])['length'] && H['push']({
        ...
        G['hasOwnProperty']('rivalItem2') && G['rivalItem2']instanceof Object && 0x0 < x()(G['rivalItem2'])['length'] && H['push']({
    ...
    getRivalBrands() {
        var G = this['getInstanceProps']()
          , H = [];
        return G['hasOwnProperty']('rivalBrand1') && G['rivalBrand1']instanceof Object && 0x0 < x()(G['rivalBrand1'])['length'] && H['push']({
        ...
        G['hasOwnProperty']('rivalBrand2') && G['rivalBrand2']instanceof Object && 0x0 < x()(G['rivalBrand2'])['length'] && H['push']({
    ...
    getCacheMap(G, H) {
        var I = this['getInstanceProps']()
          , J = H ? Object(C['l'])(I, H) : I;
        return x()(J)['filter'](function(K) {
            return G['includes'](K);
        })['map'](function(K) {
            return {
                'name': K,
