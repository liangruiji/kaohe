c.prototype.__processRequestUrl = function(e) {
    ...
    if (n.hostSetting && n.hostSetting[t.location.hostname]) {
        var r = n.hostSetting[t.location.hostname];
        r.prefix && (n.prefix = r.prefix),
        r.subDomain && (n.subDomain = r.subDomain),
        r.mainDomain && (n.mainDomain = r.mainDomain)
    }
    if (!0 === n.H5Request) {
        var i = "//" + (n.prefix ? n.prefix + "." : "") + (n.subDomain ? n.subDomain + "." : "") + n.mainDomain + "/h5/" + o.api.toLowerCase() + "/" + o.v.toLowerCase() + "/"
          , a = o.appKey || ("waptest" === n.subDomain ? "4272" : "12574478")
          , s = (new Date).getTime()
          , u = function(e) {
            function t(e, t) {
                return e << t | e >>> 32 - t
        ...
        Object.keys(o).forEach(function(e) {
            void 0 === l[e] && void 0 === c[e] && "headers" !== e && "ext_headers" !== e && "ext_querys" !== e && (l[e] = o[e])
        }),
        o.ext_querys && Object.keys(o.ext_querys).forEach(function(e) {
            l[e] = o.ext_querys[e]
        }),
        n.getJSONP ? l.type = "jsonp" : n.getOriginalJSONP ? l.type = "originaljsonp" : (n.getJSON || n.postJSON) && (l.type = "originaljson"),
        void 0 !== o.valueType && ("original" === o.valueType ? n.getJSONP || n.getOriginalJSONP ? l.type = "originaljsonp" : (n.getJSON || n.postJSON) && (l.type = "originaljson") : "string" === o.valueType && (n.getJSONP || n.getOriginalJSONP ? l.type = "jsonp" : (n.getJSON || n.postJSON) && (l.type = "json"))),
        !0 === n.useJsonpResultType && "originaljson" === l.type && delete l.type,
