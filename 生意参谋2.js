var baxiaFetchHandler = function() {
    ...
    var r = {}
      ...
      , c = {
        ...
        fire: function(e, t) {
            var n = (s = i("events", {}))[e];
            if (n)
                for (var o = 0, a = (n = n.slice()).length; a > o; o++)
                    n[o](t);
            return r
        }
    }
      ...
      , f = {
        ...
        postMessage: function(e, t) {
            ...
            i.push(o),
            f.tm || (f.tm = setInterval(function() {
                var e = f.q;
    ...
    function g(e) {
        try {
            var t = e.data.split(d)
              ...
              , i = void 0;
            t.length > 1 ? (n = t[0],
            i = t[1]) : (n = (t = JSON.parse(t[0])).type,
            i = t.content);
            for (var o = 0, a = p.length; a > o; o++)
                p[o].event === n && p[o].callback(i)
        } catch (r) {}
    }
    var m = {
        initListener: function(e) {
            u = e.originWin,
            h = e.msgTransfer,
            (l = e.currentWin) && u && h && (l.postMessage ? l.addEventListener ? l.addEventListener("message", g, !1) : l.attachEvent && l.attachEvent("onmessage", g) : f.ListenerMessage("fromFrame" == h ? u : l, g))
        },
    ...
    var v = location
      ...
      , b = function(e, t, n) {
        (void 0 === t && (t = 1),
        void 0 === n && (n = .1),
        0 >= n || Math.random() < n) && function(e, t) {
            var n = [];
            for (var i in e)
    ...
    var w = document
      , T = function(e, t, n) {
        ...
        o.onerror = function(t) {
            b("function:loadJS. msg:" + e + "load error。props：" + JSON.stringify(n)),
            o.onerror = null
        }
        ,
        t) {
      ...
      , S = function(e) {
        ...
        e.renderNC)
            if (function(e) {
                ...
                n.appendChild(i)),
                _ ? (a = "register_h5",
                T("//g.alicdn.com/sd/nch5/index.js", function() {
                    C = window.NoCaptcha,
                    l.bannerHidden = !1,
                    C.init(l),
                    C.setEnabled(!0)
                })) : (a = "register",
                T("//g.alicdn.com/sd/ncpc/nc.js", function() {
                ...
                var r = e.verifiedCallback
                  ...
                  , l = {
                    ...
                    replaceCallback: function(e, t, n) {
                        var i, a = [];
                        _ ? i = n.bind(this, "ok") : (i = e.success,
                        t = e.data),
                        a.push({
                            key: "bx-nc-ua",
                            value: t.n
    ...
    var E = function(e) {
        ...
        ,
        "GET" === e.type ? (o.open("GET", e.url + "?" + i, !0),
        o.send(null)) : "POST" === e.type && (o.open("POST", e.url, !0),
    ...
    return function(t) {
        ...
        e.prototype.formatProps = function(e) {
            ...
            return t.url = t.url || t.data && t.data.url || "",
            e.result = t,
            e
        }
          ,
        ...
        e.prototype.showDialog = function(e) {
            if (e) {
                if (this.options && (this.options.language && (e = y(e, "language=" + this.options.language)),
                this.options.ncLanguage && (e = y(e, "ncLanguage=" + this.options.ncLanguage))),
                e && -1 === e.indexOf("http"))
                    e = this.getDomain(this.currentRequest.url) + e;
                this.dialog || R("#baxia-dialog-content") ? this.show(e) : (this.render(e),
                this.show(e))
            }
        }
        ,
        ...
        e.prototype.destroy = function() {
            this.reset(),
            this.dialog && (this.dialog.innerHTML = "",
            this.dialog = null),
            this.options && this.options.renderTo && (this.options.renderTo.innerHTML = "")
        }
          ,
          // TODO 这里 4
        e.prototype.show = function(e) {
            e && this.frame && this.frame.src != e && -1 >= e.indexOf("renderIframe") && (this.frame.src = e),
            this.dialog && (this.dialog.style.display = "block"),
            c.fire("event:dialogShow@baxia"),
            this.options && this.options.showCallback && this.options.showCallback(e)
        }
        ,
        ...
        e.prototype.render = function(e) {
            ...
            var a = this.isCustomRenderTo()
              ...
              , s = O.body;
            a ? (s = o,
            r = this.getRenderContainer()) : r = '<div class="baxia-dialog-mask"></div><div class="baxia-dialog-content">\n      ' + this.getRenderContainer() + '\n      <div class="baxia-dialog-close">X</div>\n      </div>',
            i.innerHTML = r,
            s.appendChild(i);
            ...
            n.dialog = i,
            n.frame = R("#baxia-dialog-content"),
            n.frame && n.initMessenger(n.frame.contentWindow),
            n.dialogStyleFix(i),
            M && !a && n.mobileFix(),
            e.indexOf("/assist") > -1 && (c.style.display = "none",
            800 > screen.width || (i.className = i.className + " map")),
            this.props.result.renderNC ? this.handleRenderNC(t({}, this.props.result)) : "renderIframe" !== this.props.result.url || this.handleShowIframeDialog()
        }
        ,
        ...
        e.prototype.initMessenger = function(e) {
            ...
            m.register("child", function(e) {
                if (!(e = JSON.parse(decodeURIComponent(e))).queryToken && !e.smToken)
                    return t.hide();
                e.queryToken = "not-send" === e.smToken ? "" : "smToken=success",
                t.hide(!0)
            }),
        ...
        e.prototype.dialogStyleFix = function(e) {
            this.isCustomRenderTo() ? e.className += " custom-dialog-wrapper" : (e.className = " baxia-dialog auto ",
            M && (e.className += " baxia-mobile"))
        }
        ,
        ...
        e.prototype.mobileFix = function() {
            ...
            n.style.cssText = ["-webkit-transform:scale(" + o + ") translateZ(0)", "-ms-transform:scale(" + o + ") translateZ(0)", "transform:scale(" + o + ") translateZ(0)", "-webkit-transform-origin:0 0;-ms-transform-origin:0 0;transform-origin:0 0", "width:" + r + "px", "height:" + Math.max(a.height, q.innerHeight) / o + "px", "z-index:2147483647;position: fixed;left:0;top:0px", "background:" + (r > 800 ? "rgba(0,0,0,.5)" : "#FFF"), "display:none"].join(";"),
            c.on("event:dialogShow@baxia", function() {
                t = e.scrollTop,
                n.style.height = Math.max(q.innerHeight, e.scrollHeight) > q.screen.height ? q.screen.height + "px" : "100%",
        ...
        e.prototype.run = function(e) {
            var t = e.result
              , n = e.config;
            200 !== this.status ? (this.currentRequest = this.currentRequest || n,
            this.status = 200,
            this.showDialog(t.url)) : this.queue.push(n)
        }
        ,
        e.prototype.forEachQueue = function(e) {
            for (var t = [this.currentRequest].concat(this.queue), n = 0; t.length > n; n++)
                if (t[n]) {
                    if (t[n].url && t[n].url.indexOf("reqeust=getpunishpage") > -1)
        ...
        ,
        e.prototype.handleAutoSubmit = function(e, t) {}
        ,
