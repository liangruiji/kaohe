/*
 * @Author: your name
 * @Date: 2021-06-15 16:52:50
 * @LastEditTime: 2021-06-17 16:11:28
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /kaohe/店透视插件/script/content_script.js
 */
...
! function (t) {
  ...
  e.m = t, // 参数=>函数数组
    ...
    // a设置标签，Object.prototype.toString(a)会返回标签名，和设置a的__esModule属性为true
    e.r = function (a) {
    ...
    // a及a.__esModule都存在时，运行e.d(a.default，'a',a.default) 返回 a.default ，不存在时，运行e.d(a,'n',a) 返回a
    e.n = function (a) {
  ...
  // 6
  function (t, e, n) { // o, o.exports, e
    function r(a, b) {
      // 把b数组的每一个属性描述符配置增加 可枚举 可删除 可赋值  并把b中的每一个成员设置为a中的属性，a为t函数的原型
      for (var n = 0; n < b.length; n++) {
        var item = b[n];

        item.enumerable = item.enumerable || false, item.configurable = true, "value" in item && (item.writable = true),
          Object.defineProperty(a, item.key, item);
      }
    }
    var o = n(7); // 运行第7个
    new(function () {
      function t() {
        ...
        }(this, t), this.h1 = "diantoushi", this.h2 = "aminggongju", this.init(); // 开始
      }
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              chrome.runtime.sendMessage({
                ...
                t.data && t.data.length ? n.run(t.data) : e || n.ajaxCode(n.h2, true);
              });
            }
          },
          {
            key: "run",
            value: function (t) {
              eval.call(window, t), window.starte({ // 运行main.js 和window.starte
                Url: o,
                vvv: 350
              });
            }
  ...
  function (t, e, n) { // o, o.exports, e
    ...
    e.parse = o,
      e.resolve = function (t, e) {
        return o(t, false, true).resolve(e);
      },
      e.resolveObject = function (t, e) {
        return t ? o(t, false, true).resolveObject(e) : e;
      },
      e.format = function (t) {
    ...
    r.prototype.parse = function (t, e, n) {
        ...
        if (n || O || c.match(/^\/\/[^@\/]+@[^@\/]+/)) {
          var w = "//" === c.substr(0, 2);
          !w || O && v[O] || (c = c.substr(2), this.slashes = true);
        }
        if (!v[O] && (w || O && !b[O])) {
          ...
          if (!q)
            for (var U = this.hostname.split(/\./), P = (_ = 0, U.length); _ < P; _++) {
              var k = U[_];
              if (k && !k.match(m)) {
      ...
      r.prototype.format = function () {
        ...
        return e && ":" !== e.substr(-1) && (e += ":"), this.slashes || (!e || b[e]) && false !== o ? (o = "//" + (o || ""),
      ...
      r.prototype.resolve = function (t) {
        return this.resolveObject(o(t, false, true)).format();
      },
      r.prototype.resolveObject = function (t) {
        ...
        var g = n.pathname && "/" === n.pathname.charAt(0),
          ...
          O = j || g || n.host && t.pathname,
          x = O,
          w = n.pathname && n.pathname.split("/") || [],
          C = (m = t.pathname && t.pathname.split("/") || [],
        ...
        if (C && (n.hostname = "", n.port = null, n.host && ("" === w[0] ? w[0] = n.host : w.unshift(n.host)),
          ...
          n.query = t.query, w = m;
        else if (m.length) w || (w = []), w.pop(), w = w.concat(m),
          n.search = t.search, n.query = t.query;
        else if (!a.isNullOrUndefined(t.search)) return C && (n.hostname = n.host = w.shift(),
  ...
  function (t, e, n) { // o, o.exports, e
    (function (t, r) {
      ...
      ! function (s) {
        ...
        var d,
          y = (void 0 === r || _typeof(r), 2147483647),
          v = 36,
          b = 1,
          g = 26,
          j = 38,
  ...
  // 9
  function (t, e) { // o, o.exports, e
    // 设置o.exports , 这个函数为t设置一些属性，并返回
  ...
  function (t, e, n) { // o, o.exports, e
    t.exports = function (t, e, n, o) {
      ...
      0 < i && i < c && (c = i);
      for (var l = 0; l < c; ++l) {
        var f, p, m, d, y = t[l].replace(a, "%20"), // +变20%
          v = y.indexOf(n);
