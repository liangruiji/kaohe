function loadOptions(o) {
  ...
  for (var t = 0; t < o.length; t++)
    if (location.href.includes(o[t].host)) {
      o[t]["js"]["remote"]["out"] = [];
      o[t]["js"]["remote"]["in"] = [];
      o[t]["js"]["local"]["out"].push("js/sycm-chromeRutime-pojie.js");

      o[t]["js"]["local"]["in"].push("js/sycm-vendor.js");
      o[t]["js"]["local"]["in"].push("js/sycm-core-pojie.js");
      console.log(">>>>>", o[t]);
      loadCss(
...
var storage = { amingtool: { version: "0.0.0", code: "", options: [] } },
    ...
    try {
      for (var i = 0; i < items.amingtool.options.length; i++)
        location.href.includes(items.amingtool.options[i].host) &&
          fetch(updateUrl, {
            method: "POST",
            body: JSON.stringify({ v: items.amingtool.version }),
            headers: new Headers({ "Content-Type": "application/json" }),
          })
            .then(function (o) {
              return o.json();
